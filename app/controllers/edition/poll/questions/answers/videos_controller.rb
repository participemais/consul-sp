class Edition::Poll::Questions::Answers::VideosController < Edition::Poll::BaseController
  ...
  def create
    ...
    if @video.save
      redirect_to edition_answer_videos_path(@answer),
  ...
  def update
    if @video.update(video_params)
      redirect_to edition_answer_videos_path(@video.answer_id),
