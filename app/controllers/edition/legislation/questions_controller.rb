class Edition::Legislation::QuestionsController < Edition::Legislation::BaseController
  ...
  def create
    ...
    if @question.save
      ...
      redirect_to edition_legislation_process_questions_path, notice: notice
    else
  ...
  def update
    if @question.update(question_params)
      ...
      redirect_to edit_edition_legislation_process_question_path(@process, @question), notice: notice
    else
